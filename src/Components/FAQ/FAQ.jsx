        ...
        <section className="FAQ-servicesSection">
          <div className="row flex-column flex-lg-row">
            <div className=" FAQ-servicesColumn text-black fw-bold">
              <h2 className='text-black-50 my-4 large-text'>FAQ for CodeCrazeSoftware Solutions</h2>
              <ul className='fw-normal large-text FAQ-content fs-5 my-5'>
              <li class="my-2"><strong>What services does CodeCrazeSoftware Solutions offer?</strong> CodeCrazeSoftware Solutions provides a range of IT services including mobile application development (iOS, Android, Cross Platform), custom application development, website programming, software testing, and UI/UX designing.</li>
...
<li class="my-2"><strong>Do they provide cloud services?</strong> Yes, CodeCrazeSoftware Solutions offers cloud services, specifically Salesforce and Microsoft Azure.</li>
...
<li class="my-2"><strong>How can I contact CodeCrazeSoftware Solutions?</strong> You can reach them via email at CodeSoftwareSolution@gmail.com, or call 9503007527/9403452788. Their office is located at address Nagpur medical square.</li>
<li class="my-2"><strong>What industries do you specialize in?</strong> CodeCrazeSoftware Solutions specializes in various industries including healthcare, retail, finance, education, and hospitality.</li>
...
<li class="my-2"><strong>How do I start a project with CodeCrazeSoftware Solutions?</strong> You can start by contacting them through email or phone to discuss your project requirements and goals.</li>
