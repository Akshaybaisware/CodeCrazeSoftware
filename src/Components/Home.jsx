...
import ExampleCarouselImage1 from './ExampleCarouselImage1.jsx';
...
<p class="fs-lighter ">Prevoyance Solutions is a team of professionals who are striving to deliver best IT solution<br/> to people we work with..</p>
      ...
      <Row className='d-lg-none'> 
        <Col>
          <Carousel className='Carousel-Image'>
            <Carousel.Item>
              <Image src={Picture8} className='d-block w-50' alt='Enterprise Solutions' />
            
                <p className='fs-5 fw-bold'>Enterprise Solutions</p>
                <p className='text-black-50'>We work with large enterprises as well as small & medium-sized enterprises. We transform the way small, medium & large enterprises conduct their business with customers / clients, vendors / suppliers, partners and employees in this digital age</p>
            ...
            <Carousel.Item>
              <Image src={Picture9} className='d-block w-50' alt='Agencies' />
                ...
                <p className='text-black-50'>We work with consulting companies, independent software vendors (isvs), software product development companies or agencies. We partner with agencies to work on a project end-to-end, or as extended team to build their client's project successfully</p>
             
            </Carousel.Item>
            <Carousel.Item>
              <Image src={Picture10} className='d-block w-50' alt='Startups' />
            
                <p className='fs-5 fw-bold'>Startups</p>
                <p className='text-black-50'>We worked with more than 100+ global tech startups for their web/cloud/ mobile / iot needs. We empower and support startups with our digital expertise & experience at each stage whether you are at Seed stage OR Expansion stage.</p>
      ...
      <Row className='d-none d-lg-flex'> 
        ...
        <Col xs={6} md={4}>
          ...
          <p className='fs-5 fw-bold'>Startups</p>
          <p className='text-black-50'>We worked with more than 100+ global tech startups for their web/cloud/ mobile / iot needs. We empower and support startups with our digital expertise & experience at each stage whether you are at Seed stage OR Expansion stage.            </p>
          <Button variant="secondary" className='my-3 mx-4 px-4 Paragraph rounded-pill' size="lg">
          More
        </Button>
        </Col>
      </Row>
    ...
    <div className='Our_Work'>
      <Container className='content-container'>
        ...
        <p className="fs-lighter fs-4">Yes, at Prevoyance, we're obsessed with quality. We rely on our portfolio to do business and <br/> always ensure that each of our web or mobile deliverable is unique and world class.</p>
      </Container>
