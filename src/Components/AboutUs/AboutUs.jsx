...
const AboutUs = () => {
  ...
  <div className="about-us-business-relationships">
    ...
    <div className="row about-us-content">
      <div className="about-us-description-businessrelationships mt-5 col-lg-6 col-md-12">
        <p className='mt-5'>
      ...
      <div className="about-us-logos d-flex flex-column align-items-center col-lg-6 col-md-12">
